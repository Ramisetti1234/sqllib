...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."DIRECTOR_LIBRARY" AS OBJECT(
employeeid NUMBER,
name VARCHAR2(40),
address VARCHAR2(50),
phone INT(9),
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."SEQ_APP_ID"  MINVALUE 1 MAXVALUE 10000 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT" 
   (	"ACC_ID" NUMBER(10,0), 
	...
	"ACCOUNT_ACTIVATED" VARCHAR2(1 BYTE), 
	"ACCOUNT_ACTIVATION_DATE" DATE, 
	"ACCOUNT_BALANCE" NUMBER(30,10), 
	"ACC_SUB_TYPE" VARCHAR2(10 BYTE), 
	"UPI_ADDRESS" VARCHAR2(10 BYTE), 
	"UPI_ACTIVE" VARCHAR2(1 BYTE)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_12345" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"DEBIT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_12346" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"DEBIT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_12347" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"DEBIT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_12348" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"DEBIT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_12349" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"DEBIT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ACCOUNT_8" 
   (	"ACCOUNT_ID" NUMBER, 
	"ACCOUNT_NAME" VARCHAR2(16 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BANK_ACCOUNT_1" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BANK_ACCOUNT_2" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"MOBILE_NUMBER" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BANK_ACCOUNT_3" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"MOBILE_NUMBER" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BANK_ACCOUNT_4" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"MOBILE_NUMBER" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BANK_ACCOUNT_5" 
   (	"ACCOUNT_NUMBER" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"JOINING_DATE" DATE, 
	"MOBILE_NUMBER" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BIN_RANGE" 
   (	"BIN_ID" NUMBER, 
	"BIN_RANGE_FROM" NUMBER(6,0), 
	"BIN_RANGE_TO" NUMBER(6,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BIN_SUBSCRIPTION" 
   (	"BIN_NAME" VARCHAR2(100 BYTE), 
	"BIN_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUST_ADDRESS" 
   (	"CUST_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUST_NEW_APPLICATION" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."TRNS" 
   (	"TRN_ID" NUMBER, 
	"TRANS_CHANNEL" VARCHAR2(10 BYTE), 
	"TRANS_TIMESTAMP" TIMESTAMP (6), 
	"TRANS_TYPE" VARCHAR2(10 BYTE), 
	"CARD_ID" NUMBER, 
	"UPD_OFFICER" VARCHAR2(10 BYTE), 
...
--------------------------------------------------------
--  DDL for View VW_CLASS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VW_CLASS" ("BR_ID", "NAME", "EMAIL") AS 
  SELECT br_id, name, email
FROM class
WHERE City_id = email
;
REM INSERTING into SYSTEM.ACCOUNT
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_1
SET DEFINE OFF;
Insert into SYSTEM.ACCOUNT_1 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12345,'satya',to_date('01-01-24','DD-MM-RR'),1000,500,2000,100);
Insert into SYSTEM.ACCOUNT_1 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12345,'satya',to_date('01-01-24','DD-MM-RR'),1000,500,2000,100);
Insert into SYSTEM.ACCOUNT_1 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12345,'satya',to_date('01-01-24','DD-MM-RR'),1000,500,2000,100);
REM INSERTING into SYSTEM.ACCOUNT_12345
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_12346
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_12347
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_12348
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_12349
SET DEFINE OFF;
REM INSERTING into SYSTEM.ACCOUNT_2
SET DEFINE OFF;
Insert into SYSTEM.ACCOUNT_2 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12346,'sai',to_date('01-02-24','DD-MM-RR'),2000,1000,3000,150);
REM INSERTING into SYSTEM.ACCOUNT_3
SET DEFINE OFF;
Insert into SYSTEM.ACCOUNT_3 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12347,'ramesh',to_date('01-03-24','DD-MM-RR'),1500,800,2500,200);
REM INSERTING into SYSTEM.ACCOUNT_4
SET DEFINE OFF;
Insert into SYSTEM.ACCOUNT_4 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12348,'raju',to_date('01-04-24','DD-MM-RR'),1800,1200,3000,250);
REM INSERTING into SYSTEM.ACCOUNT_5
SET DEFINE OFF;
Insert into SYSTEM.ACCOUNT_5 (ACCOUNT_NUMBER,NAME,JOINING_DATE,DEBIT,CREDIT,BALANCE,INTEREST) values (12349,'rambabu',to_date('01-05-24','DD-MM-RR'),1200,700,2000,120);
REM INSERTING into SYSTEM.ACCOUNT_8
SET DEFINE OFF;
REM INSERTING into SYSTEM.ADDRESS
SET DEFINE OFF;
Insert into SYSTEM.ADDRESS (CITY_ID,CITY,PINCODE) values (1,'Mumbai','400121');
Insert into SYSTEM.ADDRESS (CITY_ID,CITY,PINCODE) values (2,'Pune','450011');
Insert into SYSTEM.ADDRESS (CITY_ID,CITY,PINCODE) values (3,'Lucknow','553001');
Insert into SYSTEM.ADDRESS (CITY_ID,CITY,PINCODE) values (4,'HYDERABAD','443221');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.BANK
SET DEFINE OFF;
Insert into SYSTEM.BANK (BANK_ID,BANK_NAME,BANK_IFSC_CODE,BRANCH) values (3,'union','12354','vijayawada');
REM INSERTING into SYSTEM.BANK_ACCOUNT_1
SET DEFINE OFF;
REM INSERTING into SYSTEM.BANK_ACCOUNT_2
SET DEFINE OFF;
Insert into SYSTEM.BANK_ACCOUNT_2 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12346,'SAIBABA',to_date('05-03-24','DD-MM-RR'),1234567891,100,500,100,800);
Insert into SYSTEM.BANK_ACCOUNT_2 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12345,'sai',to_date('05-03-24','DD-MM-RR'),1234567892,100,400,100,600);
Insert into SYSTEM.BANK_ACCOUNT_2 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12344,'ramesh',to_date('05-03-24','DD-MM-RR'),1234567892,200,400,100,700);
Insert into SYSTEM.BANK_ACCOUNT_2 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12344,'ramesh',to_date('05-03-24','DD-MM-RR'),1234567892,200,400,100,700);
REM INSERTING into SYSTEM.BANK_ACCOUNT_3
SET DEFINE OFF;
Insert into SYSTEM.BANK_ACCOUNT_3 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12347,'SATISH',to_date('05-03-24','DD-MM-RR'),1234567893,100,500,300,900);
Insert into SYSTEM.BANK_ACCOUNT_3 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12344,'ramesh',to_date('05-03-24','DD-MM-RR'),1234567892,200,400,100,700);
REM INSERTING into SYSTEM.BANK_ACCOUNT_4
SET DEFINE OFF;
Insert into SYSTEM.BANK_ACCOUNT_4 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12348,'NARESH',to_date('05-03-24','DD-MM-RR'),1234567893,100,500,200,800);
REM INSERTING into SYSTEM.BANK_ACCOUNT_5
SET DEFINE OFF;
Insert into SYSTEM.BANK_ACCOUNT_5 (ACCOUNT_NUMBER,NAME,JOINING_DATE,MOBILE_NUMBER,DEBIT,CREDIT,BALANCE,INREST) values (12349,'RAMBABU',to_date('05-03-24','DD-MM-RR'),1234567892,100,500,100,700);
REM INSERTING into SYSTEM.BIN_RANGE
SET DEFINE OFF;
REM INSERTING into SYSTEM.BIN_SUBSCRIPTION
SET DEFINE OFF;
Insert into SYSTEM.BIN_SUBSCRIPTION (BIN_NAME,BIN_ID,STATUS) values ('rjay',15,'c');
Insert into SYSTEM.BIN_SUBSCRIPTION (BIN_NAME,BIN_ID,STATUS) values ('tech',10,'b');
REM INSERTING into SYSTEM.BOOK
SET DEFINE OFF;
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('A123','B1A123','GOOD','A',5,20,'ARCHEOLOGY ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('A123','B2A123','NEW','A',6,30,'ARCHEOLOGY ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('B234','B1B234','NEW','A',2,15,'CHEMISTRY ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('C321','B1C321','BAD','A',1,10,'PHYSICS ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('H123','B1H123','GOOD','A',3,15,'CHEMISTRY ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('Z123','B1Z123','GOOD','O',4,20,'COMPUTING ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('L321','B1L321','NEW','O',4,20,'COMPUTING ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('P321','B1P321','USED','A',2,12,'CHEMISTRY ROAD');
Insert into SYSTEM.BOOK (ISBN,BOOKID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('A123','B1A188','GOOD','A',5,20,'ARCHEOLOGY ROAD');
REM INSERTING into SYSTEM.BRANCH
SET DEFINE OFF;
Insert into SYSTEM.BRANCH (NAME,ADDRESS,PHONE) values ('ARCHEOLOGY','ARCHEOLOGY ROAD',645645645);
Insert into SYSTEM.BRANCH (NAME,ADDRESS,PHONE) values ('CHEMISTRY','CHEMISTRY ROAD',622622622);
Insert into SYSTEM.BRANCH (NAME,ADDRESS,PHONE) values ('COMPUTING','COMPUTING ROAD',644644644);
Insert into SYSTEM.BRANCH (NAME,ADDRESS,PHONE) values ('PHYSICS','PHYSICS ROAD',666666666);
REM INSERTING into SYSTEM.BRANCHES
SET DEFINE OFF;
Insert into SYSTEM.BRANCHES (BRANCH_ID,BRANCH_NAME,CLIENT_ID) values (1,'Branch X',1);
Insert into SYSTEM.BRANCHES (BRANCH_ID,BRANCH_NAME,CLIENT_ID) values (2,'Branch Y',2);
Insert into SYSTEM.BRANCHES (BRANCH_ID,BRANCH_NAME,CLIENT_ID) values (3,'Branch Z',3);
REM INSERTING into SYSTEM.CARD
SET DEFINE OFF;
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (101,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (102,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (103,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (104,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (105,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (106,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (107,'B',50);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (108,'B',10);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (109,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (110,'B',15.25);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (151,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (152,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (153,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (154,'A',0);
Insert into SYSTEM.CARD (CARDID,STATUS,FINES) values (155,'A',0);
REM INSERTING into SYSTEM.CLASS
SET DEFINE OFF;
Insert into SYSTEM.CLASS (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1001,'sai',101,'sai@gmail.com',1);
Insert into SYSTEM.CLASS (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1002,'saibaba',102,'saibabab@gmail.com',2);
Insert into SYSTEM.CLASS (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1003,'bharth',103,'bharth@gmail.com',3);
REM INSERTING into SYSTEM.CLIENTS
SET DEFINE OFF;
Insert into SYSTEM.CLIENTS (CLIENT_ID,CLIENT_NAME) values (1,'Client A');
Insert into SYSTEM.CLIENTS (CLIENT_ID,CLIENT_NAME) values (2,'Client B');
Insert into SYSTEM.CLIENTS (CLIENT_ID,CLIENT_NAME) values (3,'Client C');
REM INSERTING into SYSTEM.COUNTRIES
SET DEFINE OFF;
REM INSERTING into SYSTEM.CUSTOMER
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (1,'ALFRED','BACON STREET',623623623,'alfred123','al1',to_date('12-05-18','DD-MM-RR'),101);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (2,'JAMES','DOWNTOWN ABBEY',659659659,'james123','ja2',to_date('10-05-18','DD-MM-RR'),102);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (3,'GEORGE','DETROIT CITY',654654654,'george123','ge3',to_date('21-06-17','DD-MM-RR'),103);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (4,'TOM','WASHINGTON DC.',658658658,'tom123','tom4',to_date('05-12-16','DD-MM-RR'),104);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (5,'PETER','CASTERLY ROCK',652652652,'peter123','pe5',to_date('09-08-16','DD-MM-RR'),105);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (6,'JENNY','TERRAKOTA',651651651,'jenny123','je6',to_date('30-04-17','DD-MM-RR'),106);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (7,'ROSE','SWEET HOME ALABAMA',657657657,'rose123','ro7',to_date('28-02-18','DD-MM-RR'),107);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (8,'MONICA','FAKE STREET 123',639639639,'monica123','mo8',to_date('15-01-16','DD-MM-RR'),108);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (9,'PHOEBE','CENTRAL PERK',678678678,'phoebe123','pho9',to_date('25-03-16','DD-MM-RR'),109);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (10,'RACHEL','WHEREVER',687687687,'rachel123','ra10',to_date('01-09-17','DD-MM-RR'),110);
Insert into SYSTEM.CUSTOMER (CUSTOMERID,NAME,CUSTOMERADDRESS,PHONE,PASSWORD,USERNAME,DATESIGNUP,CARDNUMBER) values (131,'sai','yeditha',783564485,'baba@123','ramisetti',to_date('02-05-24','DD-MM-RR'),101);
REM INSERTING into SYSTEM.CUSTOMERS
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMERS (CUST_ID,NAME,CITY,INDUSTRY_ID) values (101,'Samsung Customer','hyderabab',1);
Insert into SYSTEM.CUSTOMERS (CUST_ID,NAME,CITY,INDUSTRY_ID) values (102,'Apple Customer','mumbai',2);
Insert into SYSTEM.CUSTOMERS (CUST_ID,NAME,CITY,INDUSTRY_ID) values (103,'Google Customer','bangaluru',3);
REM INSERTING into SYSTEM.CUST_ADDRESS
SET DEFINE OFF;
REM INSERTING into SYSTEM.CUST_NEW_APPLICATION
SET DEFINE OFF;
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('satya','sai','baba','baba@gmail.com',9949990012,'m','null',1,711,2024042302,'A','null');
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('sai','sandhya','sunkara','sai@gmail.com',9849990012,'F','null',2,347,2024042303,'A','null');
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('prathap','reddy','kami','prathap@gmail.com',9948990012,'M','null',3,789,2024042304,'R','Dupllicate mobile_num');
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('dasari','bharth','chowdari','dasari@gmail.com',9948990012,'M','null',4,781,2024042305,'R','Duplicate email_id');
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('sharika','yamani','dasari','dasari@gmail.com',9948990011,'F','null',5,771,2024042306,'R','Duplicate email_id');
Insert into SYSTEM.CUST_NEW_APPLICATION (FIRST_NAME,MIDDLE_NAME,LAST_NAME,EMAIL_ID,MOBILE_NUM,GENDER,IFSC_CODE,D_ID,DOC_ID,APP_ID,STATUS,CMNT) values ('HARI','BABU','KONDAPALLI','hari@gmail.com',9573745213,'M','null',6,123,2024042509,'A','null');
REM INSERTING into SYSTEM.DEPARTMENTS
SET DEFINE OFF;
REM INSERTING into SYSTEM.EMP
SET DEFINE OFF;
Insert into SYSTEM.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values (7369,'SAI','CLERK',7902,to_date('17-12-80','DD-MM-RR'),8000,null,20);
REM INSERTING into SYSTEM.EMPLOYEE
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYEE (EMPLOYEEID,NAME,EMPLOYEEADDRESS,PHONE,PASSWORD,USERNAME,PAYCHECK,BRANCHNAME,CARDNUMBER) values (211,'ROSS','yousfguda',99124667,'Sai@123','ro11',211,'PHYSICS',101);
Insert into SYSTEM.EMPLOYEE (EMPLOYEEID,NAME,EMPLOYEEADDRESS,PHONE,PASSWORD,USERNAME,PAYCHECK,BRANCHNAME,CARDNUMBER) values (212,'CHANDLER','OUR HEARTHS',688688688,'chandler123','chand12',1150.5,'ARCHEOLOGY',102);
Insert into SYSTEM.EMPLOYEE (EMPLOYEEID,NAME,EMPLOYEEADDRESS,PHONE,PASSWORD,USERNAME,PAYCHECK,BRANCHNAME,CARDNUMBER) values (213,'JOEY','LITTLE ITAYLY',628628628,'joey123','jo13',975.75,'ARCHEOLOGY',103);
Insert into SYSTEM.EMPLOYEE (EMPLOYEEID,NAME,EMPLOYEEADDRESS,PHONE,PASSWORD,USERNAME,PAYCHECK,BRANCHNAME,CARDNUMBER) values (214,'VICTOR','SANTA FE',654321987,'victor123','vic14',2200,'COMPUTING',104);
Insert into SYSTEM.EMPLOYEE (EMPLOYEEID,NAME,EMPLOYEEADDRESS,PHONE,PASSWORD,USERNAME,PAYCHECK,BRANCHNAME,CARDNUMBER) values (215,'JAIRO','ARMILLA',698754321,'jairo123','ja15',2200.5,'CHEMISTRY',105);
...
SET DEFINE OFF;
Insert into SYSTEM.LOCATION (ADDRESS) values ('ARCHEOLOGY ROAD');
Insert into SYSTEM.LOCATION (ADDRESS) values ('CHEMISTRY ROAD');
Insert into SYSTEM.LOCATION (ADDRESS) values ('COMPUTING ROAD');
Insert into SYSTEM.LOCATION (ADDRESS) values ('PHYSICS ROAD');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.NAME
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRICE,STOCK_QUANTITY) values (1,'AC',50000,50);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRICE,STOCK_QUANTITY) values (2,'rice cookar',5000,25);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRICE,STOCK_QUANTITY) values (4,'TV',50000,1);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRICE,STOCK_QUANTITY) values (5,'refrigerators',500000,10);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRICE,STOCK_QUANTITY) values (6,'LPG Gas',null,15);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.RENT
SET DEFINE OFF;
Insert into SYSTEM.RENT (CARDID,ITEMID,APPORPRIATIONDATE,RETURNDATE) values (102,'B1Z123',to_date('10-05-18','DD-MM-RR'),to_date('25-05-18','DD-MM-RR'));
Insert into SYSTEM.RENT (CARDID,ITEMID,APPORPRIATIONDATE,RETURNDATE) values (104,'V1JA15',to_date('01-05-18','DD-MM-RR'),to_date('21-05-18','DD-MM-RR'));
Insert into SYSTEM.RENT (CARDID,ITEMID,APPORPRIATIONDATE,RETURNDATE) values (105,'V1DI00',to_date('02-05-18','DD-MM-RR'),to_date('25-05-18','DD-MM-RR'));
Insert into SYSTEM.RENT (CARDID,ITEMID,APPORPRIATIONDATE,RETURNDATE) values (154,'B1L321',to_date('04-05-18','DD-MM-RR'),to_date('26-05-18','DD-MM-RR'));
Insert into SYSTEM.RENT (CARDID,ITEMID,APPORPRIATIONDATE,RETURNDATE) values (155,'V1CH16',to_date('29-04-18','DD-MM-RR'),to_date('29-05-18','DD-MM-RR'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SALESMEN
SET DEFINE OFF;
Insert into SYSTEM.SALESMEN (SALESMAN_ID,NAME,AGE,SALARY) values (201,'sai',30,50000);
Insert into SYSTEM.SALESMEN (SALESMAN_ID,NAME,AGE,SALARY) values (202,'ramesh',30,60000);
Insert into SYSTEM.SALESMEN (SALESMAN_ID,NAME,AGE,SALARY) values (203,'suresh',30,70000);
...
SET DEFINE OFF;
Insert into SYSTEM.STUDENT (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1001,'sai',101,'sai@gmail.com',1);
Insert into SYSTEM.STUDENT (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1002,'saibaba',102,'saibabab@gmail.com',2);
Insert into SYSTEM.STUDENT (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1003,'bharth',103,'bharth@gmail.com',3);
Insert into SYSTEM.STUDENT (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1004,'ramesh',104,'ramesh@gmail.com',4);
Insert into SYSTEM.STUDENT (STUD_ID,NAME,BR_ID,EMAIL,CITY_ID) values (1004,'ramesh',104,'ramesh@gmail.com',4);
REM INSERTING into SYSTEM.STUDENTS
SET DEFINE OFF;
Insert into SYSTEM.STUDENTS (ROLL_NUMBER,NAME,TELUGU,ENGLISH,MATHS,HINDI,SCIENCE,SOCIAL,TOTAL_MARKS) values (1,'sai',85,80,90,75,70,95,495);
Insert into SYSTEM.STUDENTS (ROLL_NUMBER,NAME,TELUGU,ENGLISH,MATHS,HINDI,SCIENCE,SOCIAL,TOTAL_MARKS) values (2,'sathis',86,81,91,76,71,96,501);
Insert into SYSTEM.STUDENTS (ROLL_NUMBER,NAME,TELUGU,ENGLISH,MATHS,HINDI,SCIENCE,SOCIAL,TOTAL_MARKS) values (3,'bharth',100,100,100,100,100,99,599);
Insert into SYSTEM.STUDENTS (ROLL_NUMBER,NAME,TELUGU,ENGLISH,MATHS,HINDI,SCIENCE,SOCIAL,TOTAL_MARKS) values (4,'bhargavi',50,50,50,50,50,60,310);
REM INSERTING into SYSTEM.TRNS
SET DEFINE OFF;
REM INSERTING into SYSTEM.VIDEO
SET DEFINE OFF;
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('CHEMISTRY FOR DUMMIES',2016,'V1CH16','NEW','O',10,50,'CHEMISTRY ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('CHEMISTRY FOR DUMMIES',2016,'V2CH16','BAD','A',5,20,'CHEMISTRY ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('COMPUTING MANAGER',2014,'V1CO14','GOOD','A',4,20,'COMPUTING ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('JAVA LANGUAGE',2015,'V1JA15','USED','O',4,20,'COMPUTING ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('DINOSAURS',2000,'V1DI00','GOOD','O',5,25,'ARCHEOLOGY ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('T-REX, DEADLY KING',1992,'V1TR92','USED','A',10,50,'ARCHEOLOGY ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('ANCESTORS OF THE HUMANITY',1998,'V1AN98','BAD','A',3,15,'ARCHEOLOGY ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('PHYSICS, MOST BORING SH*T',2018,'V1PH18','NEW','A',1,5,'PHYSICS ROAD');
Insert into SYSTEM.VIDEO (TITLE,YEAR,VIDEOID,STATE,AVALABILITY,DEBYCOST,LOSTCOST,ADDRESS) values ('CHEMISTRY FOR DUMMIES',2016,'V1CH19','NEW','A',5,28,'PHYSICS ROAD');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."RENT_PK" ON "SYSTEM"."RENT" ("CARDID", "ITEMID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UK_BANK_IFSC
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UK_BANK_IFSC" ON "SYSTEM"."BANK" ("BANK_IFSC_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."VIDEO_PK" ON "SYSTEM"."VIDEO" ("TITLE", "YEAR", "VIDEOID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."BOOK_PK" ON "SYSTEM"."BOOK" ("ISBN", "BOOKID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."BRANCH_PK" ON "SYSTEM"."BRANCH" ("NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CARD_PK" ON "SYSTEM"."CARD" ("CARDID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."COUNTRY_C_ID_PK" ON "SYSTEM"."COUNTRIES" ("COUNTRY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CUSTOMER_PK" ON "SYSTEM"."CUSTOMER" ("CUSTOMERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."DEPT_ID_PK" ON "SYSTEM"."DEPARTMENTS" ("DEPARTMENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."EMPLOYEE_PK" ON "SYSTEM"."EMPLOYEE" ("EMPLOYEEID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."EMP_EMAIL_UK" ON "SYSTEM"."EMPLOYEES" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."JOB_ID_PK" ON "SYSTEM"."JOBS" ("JOB_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."LOCATION_PK" ON "SYSTEM"."LOCATION" ("ADDRESS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."LOC_ID_PK" ON "SYSTEM"."LOCATIONS" ("LOCATION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."ADDCARDCUSTO_LIBRARY" 
AFTER INSERT
ON customer
FOR EACH ROW
DECLARE
...
END;
/
ALTER TRIGGER "SYSTEM"."ADDCARDCUSTO_LIBRARY" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ADDCARDEMP_LIBRARY
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."ADDCARDEMP_LIBRARY" 
AFTER INSERT
ON employee
FOR EACH ROW
DECLARE
...
END;
/
ALTER TRIGGER "SYSTEM"."ADDCARDEMP_LIBRARY" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MODIFYFINES_LIBRARY
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."MODIFYFINES_LIBRARY" 
AFTER DELETE
ON rent
FOR EACH ROW
DECLARE
...
/
ALTER TRIGGER "SYSTEM"."MODIFYFINES_LIBRARY" ENABLE;
--------------------------------------------------------
--  DDL for Procedure ADDBOOK_LIBRARY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADDBOOK_LIBRARY" (auxISBN IN VARCHAR2, auxBookID IN VARCHAR2, auxState IN VARCHAR2, auxDebyCost IN NUMBER,
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADDCUSTOMER_LIBRARY" (auxCustomerId IN NUMBER, auxName IN VARCHAR2, auxCustomerAddress IN VARCHAR2, auxPhone IN NUMBER,
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADDVIDEO_LIBRARY" (auxTitle IN VARCHAR2, auxYear IN INT, auxVideoID IN VARCHAR2, auxState IN VARCHAR2, auxDebyCost IN NUMBER,
auxLostCost IN NUMBER, auxAddress IN VARCHAR2)
IS
BEGIN
  INSERT INTO video
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ALLMEDIA_LIBRARY" (mediaType VARCHAR2)
IS
  CURSOR cBooks
  IS
    SELECT *
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."CUSTOMERACCOUNT_LIBRARY" (custoID IN customer.customerid%TYPE)
    is
     auxCard NUMBER;
  auxFines NUMBER;
  auxItem VARCHAR(6);
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."EMPLOYEEACCOUNT_LIBRARY" (emploID IN employee.employeeid%TYPE)
IS
  auxCard NUMBER;
  auxFines NUMBER;
  auxItem VARCHAR(6);
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."HANDLERETURNS_LIBRARY" (auxItemID IN VARCHAR2)
IS
  auxRented NUMBER;
  auxBook NUMBER;
  auxVideo NUMBER;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."LOGINCUSTOMER_LIBRARY" (user IN VARCHAR2, pass IN VARCHAR2)
       is
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."LOGINEMPLOYEE_LIBRARY" (user IN VARCHAR2, pass IN VARCHAR2)
       is
        passAux customer.password%type;
        incorrect_password EXCEPTION;
   begin
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PAYFINES_LIBRARY" (auxCard IN card.cardid%TYPE, money IN NUMBER)
IS
  finesAmount NUMBER;
  total NUMBER;
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_APPL_VALIDATION" 
AS
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_DB" (var VARCHAR2) IS
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_DEBUG" (var varchar2)
as
begin
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_EMP" 
AS
V_EMPNO NUMBER;
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_EMPLOYEE" (var VARCHAR2) IS
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_EMP_DML" (pempno number)
as
v_sal number;
v_comm number;
begin
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_NEW_APPLICATION" (
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_PRINT_EVEN_NUMBERS" (pnumber number)
as
begin
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC_PRINT_NUMBER" (pnumber number)
as
begin
for i in 1..pnumber loop
    dbms_output.put_line(i);
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRC__NEW_APPLICATION" (INPUT_TEST VARCHAR2)
AS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PRINT_EMPLOYEE_DETAILS" (
    p_job VARCHAR2,
    p_dept_no NUMBER,
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REMOVEITEM_LIBRARY" (auxItemID IN VARCHAR2)
IS
  auxBook NUMBER;
  auxVideo NUMBER;
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."RENTITEM_LIBRARY" (auxCard IN NUMBER, auxItemID IN VARCHAR2, itemType IN VARCHAR2, auxDate IN DATE)
IS
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATEINFOCUSTO_LIBRARY" (auxCustomer IN customer.customerid%TYPE, pNumber NUMBER, address VARCHAR2, newPass VARCHAR2)
IS
BEGIN
  UPDATE customer
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATEINFOEMP_LIBRARY" (auxEmployee IN employee.employeeid%TYPE, pNumber NUMBER, address VARCHAR2, newPass VARCHAR2, newPayCheck NUMBER,
newBranch VARCHAR2)
IS
BEGIN
  UPDATE employee
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATE_CUST_DETAILS" (
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."VIEWCUSTOMER_LIBRARY" (auxCustomerID IN NUMBER)
IS
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."VIEWITEM_LIBRARY" (auxItemID IN VARCHAR2)
  IS
   auxISBN VARCHAR2(4);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_GEN_NUMBERS" 
return boolean
as
begin
    for i in 1..100 loop
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_NEW_SAL_UPDATE" (pempno number)
return number
as
v_sal number;
v_comm number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_UPSAL_WITH_COMM" (pempno number)
RETURN NUMBER 
AS
v_sal NUMBER;
BEGIN
...
--------------------------------------------------------
--  Constraints for Table ACCOUNT_8
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ACCOUNT_8" MODIFY ("ACCOUNT_BALANCE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACCOUNT_8" ADD PRIMARY KEY ("ACCOUNT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ACCOUNT_8" ADD UNIQUE ("ACCOUNT_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTS" ADD PRIMARY KEY ("CLIENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BANK" ADD CONSTRAINT "UK_BANK_IFSC" UNIQUE ("BANK_IFSC_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BRANCH" ADD CONSTRAINT "BRANCH_PK" PRIMARY KEY ("NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STUDENTS" ADD PRIMARY KEY ("ROLL_NUMBER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TRNS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TRNS" ADD PRIMARY KEY ("TRN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table BIN_RANGE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."BIN_RANGE" ADD PRIMARY KEY ("BIN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."BIN_RANGE" ADD UNIQUE ("BIN_RANGE_FROM")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."BIN_RANGE" ADD UNIQUE ("BIN_RANGE_TO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."BIN_RANGE" ADD UNIQUE ("BIN_TYPE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUST_ADDRESS" MODIFY ("CUST_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SALESMEN" ADD PRIMARY KEY ("SALESMAN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOCATION" ADD CONSTRAINT "LOCATION_PK" PRIMARY KEY ("ADDRESS")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."JOBS" MODIFY ("JOB_TITLE" CONSTRAINT "JOB_TITLE_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."JOBS" ADD CONSTRAINT "JOB_ID_PK" PRIMARY KEY ("JOB_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RENT" ADD CONSTRAINT "RENT_PK" PRIMARY KEY ("CARDID", "ITEMID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table BIN_SUBSCRIPTION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."BIN_SUBSCRIPTION" MODIFY ("BIN_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BIN_SUBSCRIPTION" MODIFY ("BIN_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VIDEO" ADD CHECK ((avalability = 'A') OR (avalability = 'O')) ENABLE;
  ALTER TABLE "SYSTEM"."VIDEO" ADD CONSTRAINT "VIDEO_PK" PRIMARY KEY ("TITLE", "YEAR", "VIDEOID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ACCOUNT" MODIFY ("CUST_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACCOUNT" ADD PRIMARY KEY ("ACCOUNT_NUMBER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ACCOUNT" ADD UNIQUE ("ACC_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ACCOUNT" ADD UNIQUE ("UPI_ADDRESS")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("LAST_NAME" CONSTRAINT "EMP_LAST_NAME_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("EMAIL" CONSTRAINT "EMP_EMAIL_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("HIRE_DATE" CONSTRAINT "EMP_HIRE_DATE_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("JOB_ID" CONSTRAINT "EMP_JOB_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "EMP_SALARY_MIN" CHECK (salary > 0) ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "EMP_EMAIL_UK" UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COUNTRIES" MODIFY ("COUNTRY_ID" CONSTRAINT "COUNTRY_ID_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COUNTRIES" ADD CONSTRAINT "COUNTRY_C_ID_PK" PRIMARY KEY ("COUNTRY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REGIONS" MODIFY ("REGION_ID" CONSTRAINT "REGION_ID_NN" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BOOK" ADD CHECK ((avalability = 'A') OR (avalability = 'O')) ENABLE;
  ALTER TABLE "SYSTEM"."BOOK" ADD CONSTRAINT "BOOK_PK" PRIMARY KEY ("ISBN", "BOOKID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARD" ADD CHECK ((status = 'A') OR (status = 'B')) ENABLE;
  ALTER TABLE "SYSTEM"."CARD" ADD CONSTRAINT "CARD_PK" PRIMARY KEY ("CARDID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOCATIONS" MODIFY ("CITY" CONSTRAINT "LOC_CITY_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOCATIONS" ADD CONSTRAINT "LOC_ID_PK" PRIMARY KEY ("LOCATION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLOYEE" ADD CONSTRAINT "EMPLOYEE_PK" PRIMARY KEY ("EMPLOYEEID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPARTMENTS" MODIFY ("DEPARTMENT_NAME" CONSTRAINT "DEPT_NAME_NN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD CONSTRAINT "DEPT_ID_PK" PRIMARY KEY ("DEPARTMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMERS" ADD PRIMARY KEY ("CUST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER" ADD CONSTRAINT "CUSTOMER_PK" PRIMARY KEY ("CUSTOMERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BOOK" ADD CONSTRAINT "BOOK_FK" FOREIGN KEY ("ADDRESS")
	  REFERENCES "SYSTEM"."LOCATION" ("ADDRESS") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BRANCH
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."BRANCH" ADD CONSTRAINT "BRANCH_FK" FOREIGN KEY ("ADDRESS")
	  REFERENCES "SYSTEM"."LOCATION" ("ADDRESS") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BRANCHES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."BRANCHES" ADD FOREIGN KEY ("CLIENT_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER" ADD CONSTRAINT "CUSTOMER_FK" FOREIGN KEY ("CARDNUMBER")
	  REFERENCES "SYSTEM"."CARD" ("CARDID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLOYEE" ADD CONSTRAINT "EMPLOYEE_FK_CARD" FOREIGN KEY ("CARDNUMBER")
	  REFERENCES "SYSTEM"."CARD" ("CARDID") ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEE" ADD CONSTRAINT "EMPLOYEE_FK_BRANCH" FOREIGN KEY ("BRANCHNAME")
	  REFERENCES "SYSTEM"."BRANCH" ("NAME") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table INVOICES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INVOICES" ADD FOREIGN KEY ("BRANCH_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDERS" ADD FOREIGN KEY ("CUST_ID")
	  REFERENCES "SYSTEM"."CUSTOMERS" ("CUST_ID") ENABLE;
  ALTER TABLE "SYSTEM"."ORDERS" ADD FOREIGN KEY ("SALESMAN_ID")
	  REFERENCES "SYSTEM"."SALESMEN" ("SALESMAN_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VIDEO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VIDEO" ADD CONSTRAINT "VIDEO_FK" FOREIGN KEY ("ADDRESS")
	  REFERENCES "SYSTEM"."LOCATION" ("ADDRESS") ENABLE;
